    ...
    <div id='Home' className='Page1'>
        <div  className='Con1'>
          ...
          <div className='Buttons'>
            <Link to="/GDSC-Veecsha/WebDev" className='navBtn btns webBtn' >Web Development</Link>
            <Link to="/GDSC-Veecsha/DSA" className='navBtn btns dsaBtn'>Data Structures & Algorithms</Link>
          </div>
        </div>
    </div>
  )
